...
export default function DashboardOrderCreate(props) {
    ...
    useEffect(()=>{
        if (chooseUser === false) {
            axios.get(`${process.env.REACT_APP_END_POINT}/vietnam`)
                .then(res => {
                    ...
                    if (order) {
                        ...
                        if(typeof order.orderList !== "undefined") {
                            order.orderList.map((item)=>{
                                axios.get(`${process.env.REACT_APP_END_POINT}/products/${item.id}`)
                                    .then(res => {
        ...
        axios.get(`${process.env.REACT_APP_END_POINT}/users/list`)
            .then(res => {
    ...
    const onSubmit = (event) => {
        ...
        axios.post(`${process.env.REACT_APP_END_POINT}/order/update/${order._id}`, {
            orderName: orderName,
