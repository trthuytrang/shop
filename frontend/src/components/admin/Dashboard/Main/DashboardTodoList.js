...
export default function DashboardTodoList(props) {
    ...
    useEffect(()=>{
        axios.get(`${process.env.REACT_APP_END_POINT}/todos`)
            .then(res => {
    ...
    const clickToCheck = (event)=>{
        ...
        axios.post(`${process.env.REACT_APP_END_POINT}/todos/update`, {
            id: id,
            isDone: isDone
        }) 
    }
    ...
    const addNewTodo = (event)=>{
        ...
        axios.post(`${process.env.REACT_APP_END_POINT}/todos`, data)
        .then((res) => {   
            axios.get(`${process.env.REACT_APP_END_POINT}/todos`)
                .then(res2 => {
    ...
    const deleteTodo = (event) => { 
        ...
        axios.post(`${process.env.REACT_APP_END_POINT}/todos`, {
            delete: true,
            id: id
        }).then((res)=>{
            const virtualTodo = []
