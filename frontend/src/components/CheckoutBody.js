    ...
    const placeAnOrder = () => {
        ...
        if (orderPaymentMethod2 === "") {
            ...
            if (isPaid === false) {
                ...
                axios.post(`${process.env.REACT_APP_END_POINT}/order`, data)
                setTimeout(()=>{ 
                    setConfirm(true)
                                ...
                                <div className="payment-method-list">
                                    <div 
                                        ...
                                        <div 
                                            ...
                                            ></div>
                                            <p onClick={() => {window.open('/zalopay/gateway', 'newwindow', 'width=400,height=500')}}
                                                id="1"
                                                >CASH ON DELIVERY</p>
                                        </div>
                                    <div 
                                    ...
                                    <div 
                                        ...
                                        <div 
                                            ...
                                            ></div>
                                            <p onClick={() => {window.open('localhost:3000/zalopay/gateway', 'newwindow', 'width=400,height=500')}}
                                                id="3"
                                                >PAYMENT BY CARD</p>
                                        </div>
                                </div>
