...
export default function ProductReview(props) {
    ...
    const sendReview = (event) => {
        ...
        if (userInfo) {
            ...
            axios.post(`${process.env.REACT_APP_END_POINT}/products/review/${product._id}`, data)
            ...
            const data = {
                ...
                ratingEmail: emailInput,
                ratingStar: ratingValue,
                ratingAvt: `${process.env.REACT_APP_END_POINT}/images/16f9bbf512b66a228f7978e34d8fb163`
            }
            axios.post(`${process.env.REACT_APP_END_POINT}/products/review/${product._id}`, data)
            setProductVote(productVote=>[...productVote, data])
            setReviewInput("")
