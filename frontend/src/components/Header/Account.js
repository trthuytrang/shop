...
function Account(props) {
    ...
    const handleOnSubmit = (event) => {
        ...
        if (tabID === 0) {
            console.log(user);
            axios.post(`${process.env.REACT_APP_END_POINT}/users/login`, {
            ...
            axios.post(`${process.env.REACT_APP_END_POINT}/users/register`, {
    ...
    useEffect(()=> {
        axios.get(`${process.env.REACT_APP_END_POINT}/users/${localStorage.getItem('user-id')}`, { 
